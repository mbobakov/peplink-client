			...
			[]WanStatus{
				{
					...
					Mode:         "",
					Dns:          []string(nil),
					AditionalIp:  []string(nil),
					MTU:          1440,
					MSS:          0,
					Mac:          "",
					Wireless: WifiInfo{SSID: "",
						BSSID: "",
						Signal: Signal{RSSI: 0,
							SINR:     0,
							SNR:      0,
							ECIO:     0,
							RSRP:     0,
					...
					Modem: ModemObj{Name: "",
						...
						DialNumber:  "",
						Band:        []BandObj(nil),
						Gobi: GobiObj{RoamingStatus: RoamingObj{Code: 0,
							Message: ""},
							Network:       "",
							MobileType:    "",
							ModulePowerOn: false,
							SIM:           []SIMGroupObj(nil),
							RemoteSIM: RemoteSIMObj{IMSI: "", SerialNumber: "",
								Slot:     0,
								AutoApp:  false,
								APN:      "",
								Username: "",
								Password: ""},
							SpeedFusionConnect5gLTE: SpeedFusionConnect5gLTE{Active: false,
								Iccid: ""},
							Carrier: CarrierObj{Name: "",
								Country: ""},
							CarrierAggregation: false,
							...
							MCC:            "",
							MNC:            "",
							CellTower: CellTowerObj{CellID: 0,
								CellPlmn:    0,
								CellUtranID: 0,
								Tac:         0},
							Model:    "",
					...
					Cellular: GobiObj{RoamingStatus: RoamingObj{Code: 0,
						Message: ""},
						Network:       "",
						MobileType:    "",
						ModulePowerOn: false,
						SIM:           []SIMGroupObj(nil),
						RemoteSIM: RemoteSIMObj{IMSI: "",
							SerialNumber: "",
							Slot:         0,
							AutoApp:      false,
							APN:          "",
				...
				},
				{
					...
					Cellular: GobiObj{RoamingStatus: RoamingObj{Code: 0,
						...
						SIM: []SIMGroupObj{
							{
								...
								AutoApn:         true,
								Apn:             "web.carrier1.de",
								BandwidthAllowanceMonitor: BandwidthAllowanceMonitorObj{Enable: false,
									HasSMTP: false},
							},
						...
						SpeedFusionConnect5gLTE: SpeedFusionConnect5gLTE{Active: false,
							Iccid: "1111111111111"},
						Carrier: CarrierObj{Name: "Carrier1",
							Country: "Germany"},
						CarrierAggregation: false,
						SignalLevel:        5,
						RAT: []RatObj{
						...
						MCC:            "262",
						MNC:            "02",
						CellTower: CellTowerObj{CellID: 11111,
							CellPlmn:    22222,
							CellUtranID: 333333,
							Tac:         33333},
						Model:    "Model1",
				...
				},
				{
					...
					Cellular: GobiObj{RoamingStatus: RoamingObj{Code: 0,
						...
						SpeedFusionConnect5gLTE: SpeedFusionConnect5gLTE{Active: false,
							Iccid: "1111111111"},
						Carrier: CarrierObj{Name: "Carrier2",
							Country: "Germany"},
						CarrierAggregation: false,
						SignalLevel:        5,
						RAT: []RatObj{
